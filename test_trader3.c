...
// Communication between traders so trader 1 only sends cmds after trader 2
// Signals itself that it has done signalling (received r)

// TEST set 1 (wash trades) - probably don't test this on own
char* commands[] = {
    "BUY 0 GPU 600 20;",
    "BUY 1 Router 300 20;",
    "SELL 2 GPU 21 50;",
...
char* disconnect_trigger = "AMENDED 0";
