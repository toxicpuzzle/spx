CC=gcc
CFLAGS=-Wall -Werror -Wvla -O0 -std=c11 -g -fprofile-arcs -ftest-coverage
OFLAGS=-c $(CFLAGS)

CTESTFLAGS = -Wall -Werror -Wvla -O0 -std=c11 -g -lm
...
all: spx_exchange.o test_trader.o spx_trader.o test_trader2.o
	$(CC) $(LDFLAGS) $(CFLAGS) spx_exchange.o -lm -o spx_exchange 
	$(CC) $(LDFLAGS) $(CFLAGS) test_trader.o -lm -o test_trader 
	$(CC) $(LDFLAGS) $(CFLAGS) spx_trader.o -lm -o spx_trader  
	$(CC) $(LDFLAGS) $(CFLAGS) test_trader2.o -lm -o test_trader2
